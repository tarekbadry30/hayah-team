    ...
    <div class="custom-data-table ">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                     <a href="{{route('contact-us.export')}}" class="btn btn-outline-secondary waves-effect waves-light col-sm-2 mx-1"><i class="fas fa-file-export"></i></a>
...
@section('js')
    <script>
        ...
        function setPage(page,itemsPerPage) {
            customDataTable($('#mainTable tbody'),$(".pagination-container"),'{{route('contact-us.dataTable')}}',page,'get',itemsPerPage);
        }
           ...
           await $.ajax({
            ...
            for(let item of results){
                ...
                tableContent+=`<tr>
                    ...
                    href="{{route('contact-us.index')}}/${item.id}" title="{{__('frontend.delete')}}"><i class="fas fa-trash-alt"></i></button>
