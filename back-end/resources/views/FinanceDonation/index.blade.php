                    ...
                    <div class="row filters_container">
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <select class="form-control status" name="status">
                                ...
                                <option value="error">{{__('frontend.error')}}</option>
                            </select>
                        </div>
                        <div class="col-md-3 form-group">
...
@section('js')
        ...
        function setPage(page,itemsPerPage) {
            customDataTable($('#mainTable tbody'),$(".pagination-container"),'{{route('finance-donations.dataTable')}}',page,'get',itemsPerPage);
        }
