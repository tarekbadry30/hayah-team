        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{route('Dashboard')}}" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                            <img src="{{asset('logo.png')}}" class="website-logo" alt="" height="20">
                        </span>
                </a>
...
-->
            ...
            @guest
                <div class="dropdown d-none d-lg-inline-block ms-1">
                    @if (Route::has('login'))
                        <a type="button" class="btn header-item noti-icon waves-effect" href="{{ route('login') }}">
                            {{ __('Login') }}
                        </a>
                    @endif
                    @if (Route::has('register'))
                        <a type="button" class="btn header-item noti-icon waves-effect" href="{{ route('register') }}">
                            {{ __('Register') }}
                        </a>
                    @endif
