    ...
    <div class="custom-data-table ">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <a href="{{route('form-sheets.create')}}" class="btn btn-outline-secondary waves-effect waves-light col-sm-3 mx-1"><i class=" fas fa-plus"></i></a>
                ...
                <div class="col-sm-12">
                    <div class="row filters_container">
                        <div class="col-md-3 form-group">
                            <label class="col-form-label">{{__('frontend.userType')}}</label>
                        ...
                        <div class="col-md-3 form-group">
                            <label class="col-form-label">{{__('frontend.visibleRange')}}</label>
            ...
            <table id="mainTable" class="mt-3 table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                <thead>
                    <tr>
                        ...
                        <th>{{__('frontend.inputs')}}</th>
                        <th>{{__('frontend.answers')}}</th>
                        <th>{{__('frontend.from')}}</th>
                        <th>{{__('frontend.to')}}</th>
...
@section('js')
    ...
    <script>
        ...
        function setPage(page,itemsPerPage) {
            customDataTable($('#mainTable tbody'),$(".pagination-container"),'{{route('form-sheets.dataTable')}}',page,'get',itemsPerPage);
        }
           ...
           await $.ajax({
            ...
            for(let item of results){
                ...
                tableContent+=`<tr>
                    ...
                    href="{{route('form-sheets.index')}}/${item.id}" donation_help_id="${item.id}" title="{{__('frontend.delete')}}"><i class="fas fa-trash-alt"></i></button>
