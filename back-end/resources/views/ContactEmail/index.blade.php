    ...
    <div class="custom-data-table ">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <a href="{{route('settings.contact-emails.create')}}" class="btn btn-outline-secondary waves-effect waves-light col-sm-2 mx-1"><i class=" fas fa-plus"></i></a>
...
@section('js')
    <script>
        ...
        function setPage(page,itemsPerPage) {
            customDataTable($('#mainTable tbody'),$(".pagination-container"),'{{route('settings.contact-emails.dataTable')}}',page,'get',itemsPerPage);
        }
                ...
                tableContent+=`<tr>
                    ...
                    <td>
                            ...
                            <button class="btn btn-outline-danger delete-btn  waves-effect waves-light"
                                href="{{route('settings.contact-emails.index')}}/${item.id}" title="{{__('frontend.delete')}}">
                                <i class="fas fa-trash-alt"></i> </button>
                            <a class="btn btn-outline-success  waves-effect waves-light"
                                href="{{route('settings.contact-emails.index')}}/${item.id}/edit" title="{{__('frontend.edit')}}">
